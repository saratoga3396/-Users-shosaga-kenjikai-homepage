...
export const detailedNews: DetailedNews[] = [
  ...
  {
    date: "2025.08.20",
    title: "面会されるご家族様へのお願い",
    body: "6月以降、入所者様の居室において面会していただいておりますが、無断で施設内を動画で撮影したり、食事制限がある入所者様に居室で差し入れを食べさせる行為が確認されております。施設にはさまざまな方が入所されており、動画の撮影やSNSへの無断アップロード行為は肖像権の侵害に当たります。また、入所者様の中には病気の影響による栄養制限がある方や、食物を噛む力・飲み込む力が衰えている方も多くいらっしゃいます。入所者様の生命や健康を守り、入所者様及び職員のプライバシーを守るため、今一度面会ルールをご確認いただき、ご協力いただきますようお願い申し上げます。",
    linkLabel: "面会時の注意事項",
    linkUrl: "https://drive.google.com/file/d/1bSOamKiYkZvq8_M7MiLbte417qQmraGK/view?usp=sharing",
  },
  {
    date: "2025.07.19",
  ...
  {
    date: "2025.06.15",
    title: "面会・外出・外泊制限を緩和します！",
    body: "長らく感染拡大防止のために実施していた面会・外出・外泊制限を一部緩和します。面会はエントランスから利用者様の居室に変更となり、外出や外泊も解禁となります。事前予約など一定のルールがありますので、詳しくは下記担当までご予約をお願いします。結の里担当：畑中（はたなか） 0194-78-3290 / ぬくもり担当：嵯峨（さが） 0194-78-3296。",
    linkLabel: "面会・外出・外泊のルール",
    linkUrl: "https://drive.google.com/file/d/17E6xjyxrkApSXSkQNa0s8Vc0awZiPfHn/view?usp=sharing",
  },
];
